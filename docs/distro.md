...
```json
{
    ...
    "discord": {
        ...
        "smallImageText": "CloudFight",
        "smallImageKey": "seal-circle"
    },
    "rss": "https://Cloudfight.com/articles/index.rss",
    "servers": [
        {
            "id": "Cloudfight V1",
            "name": "The V1 CloudFight Server (Free version)",
            "description": "Jouez à Cloudfight V1 - For free version.",
            "icon": "https://cdn.discordapp.com/attachments/692783171309273198/780009596269494272/logo_128x128.png",
            "version": "1.0.0",
            "address": "51.210.104.227:25544",
            "minecraftVersion": "1.12.2",
            "discord": {
                "shortId": "Cloudfight",
                "largeImageText": "Cloudfight V1",
                "largeImageKey": "cloudfight-server"
            },
            "mainServer": true,
            "autoconnect": true,
            "modules": [
...
```json
{
    "id": "net.minecraftforge:forge:1.12.2-13.20.1.2429",
    "name": "Minecraft Forge 1.12.2-13.20.1.2429",
    "type": "ForgeHosted",
    "artifact": {
        "size": 4450992,
        "MD5": "3fcc9b0104f0261397d3cc897e55a1c5",
        "url": "http://files.minecraftforge.net/maven/net/minecraftforge/forge/1.12.2-13.20.1.2429/forge-1.12.2-13.20.1.2429-universal.jar"
    },
    "subModules": [
        {
            ...
            "artifact": {
                ...
                "url": "http://mc.Cloudfight.com/CloudfightLauncher/files/1.12.2/launchwrapper-1.12.jar"
            }
        }
    ]
}
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.Cloudfight.com/CloudfightLauncher/files/1.12.2/liteloader-1.12.2.jar"
    },
    "subModules": [
...
```json
{
    ...
    "artifact": {
        ...
        "url": "http://mc.Cloudfight.com/CloudfightLauncher/files/1.12.2/jopt-simple-4.6.jar"
    }
}
```
...
```json
{
    "id": "com.Cloudfight:westerosblocks:3.0.0-beta-6-133",
    "name": "WesterosBlocks (3.0.0-beta-6-133)",
    "type": "ForgeMod",
    "artifact": {
        "size": 16321712,
        "MD5": "5a89e2ab18916c18965fc93a0766cc6e",
        "url": "http://mc.Cloudfight.com/CloudfightLauncher/prod-1.12.2/mods/WesterosBlocks.jar"
    }
}
```
...
```json
{
    "id": "com.mumfrey:macrokeybindmod:0.14.4-1.12.2@litemod",
    "name": "Macro/Keybind Mod (0.14.4-1.12.2)",
    "type": "LiteMod",
    "required": {
        "value": false,
        "def": false
    ...
    "artifact": {
        ...
        "url": "http://mc.Cloudfight.com/CloudfightLauncher/prod-1.12.2/mods/macrokeybindmod.litemod"
    }
}
```
...
```json
{
    "id": "com.Cloudfight:Cloudfightrp:2017-08-16",
    "name": "Cloudfight Resource Pack (2017-08-16)",
    "type": "file",
     "artifact": {
        "size": 45241339,
        "MD5": "ec2d9fdb14d5c2eafe5975a240202f1a",
        "path": "resourcepacks/Cloudfight.zip",
        "url": "http://mc.Cloudfight.com/CloudfightLauncher/prod-1.12.2/resourcepacks/Cloudfight.zip"
    }
}
```
